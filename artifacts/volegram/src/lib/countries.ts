...
// Put Serbia first for UX
export const COUNTRIES_SORTED: Country[] = [
  COUNTRIES.find(c => c.code === "RS")!,
  COUNTRIES.find(c => c.code === "BA")!,
  COUNTRIES.find(c => c.code === "ME")!,
  COUNTRIES.find(c => c.code === "HR")!,
  COUNTRIES.find(c => c.code === "MK")!,
  COUNTRIES.find(c => c.code === "SI")!,
  { code: "_", name: "─────────────", dial: "", flag: "" },
  ...COUNTRIES.filter(c => !["RS","BA","ME","HR","MK","SI"].includes(c.code))
